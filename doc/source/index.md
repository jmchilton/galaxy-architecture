...
Galaxy's architecture is built around several key design patterns and systems. This documentation covers:
...
This documentation is the source of truth for Galaxy's architecture. It's maintained separately and generated in multiple formats:

- Training slides for the Galaxy Training Network
- Sphinx documentation (this project)
- Hub articles on galaxyproject.org
