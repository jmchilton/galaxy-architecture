...
Architecture documentation for Galaxy's application components.

## Content

This topic covers application components patterns and practices in Galaxy.
...
- Original slides: architecture-8-application-components
